...
args = {
    "project_id": "user1-0519-deploy_model-0519171426",
}

dag = DAG(
    "user1-0519-deploy_model-0519171426",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user1-0519-deploy_model.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="user1-0519-deploy_model-0519171426",
