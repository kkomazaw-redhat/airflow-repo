...
args = {
    "project_id": "user1-0603-01-spark-0603054642",
}

dag = DAG(
    "user1-0603-01-spark-0603054642",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user1-0603-01-spark.pipeline.",
